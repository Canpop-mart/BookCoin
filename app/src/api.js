...
export const api = {
  ...
  setPinnedQuote: (b) => req('/me/pinned-quote', { method: 'POST', body: b }),
  ...
  createBounty: (b) => req('/me/bounties', { method: 'POST', body: b }),
  cancelBounty: (id) => req(`/me/bounties/${id}/cancel`, { method: 'POST' }),

  books: () => req('/me/books'),
  book: (id) => req('/me/books/' + id),
  ...
  admin: {
    ...
    sessionDeletions: () => req('/admin/session-deletions'),
    approveSessionDeletion: (id) => req(`/admin/session-deletions/${id}/approve`, { method: 'POST' }),
    rejectSessionDeletion: (id) => req(`/admin/session-deletions/${id}/reject`, { method: 'POST' }),
